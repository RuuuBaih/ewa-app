  ...
  class App < Roda
    ...
    route do |routing|
      ...
      routing.root do
        ...
        flash.now[:notice] = '尋找城市，開啟饗宴！ Search a place to get started!' if history['id'].empty?
        ...
        routing.is do
          ...
          routing.post do
            ...
            if (filter_item['min_money'].to_i >= filter_item['max_money'].to_i) ||
               filter_item['min_money'].to_i.negative? || (filter_item['max_money'].to_i <= 0)
          ...
          routing.on String do |rest_id|
            routing.get do
              ...
              if rest_find.failure?
                ...
                unless rest_detail.address.include?(rest_detail.town)
